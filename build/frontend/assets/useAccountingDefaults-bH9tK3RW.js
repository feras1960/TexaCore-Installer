import{g as o}from"./vendor-data-CLVn9T7b.js";import{s as i}from"./index-V9x08Imb.js";function s(t){return o({queryKey:["accounting_defaults",t],queryFn:async()=>{if(!t)return null;const{data:e,error:a}=await i.from("company_accounting_settings").select(`
