import{s as y,Q as v}from"./index-YLAbNaHZ.js";import"./vendor-data-BWRv08bE.js";import"./vendor-react-CtdH4caE.js";import"./vendor-pdf-B4TnB1dM.js";import"./vendor-ui-CH3JoNoZ.js";import"./vendor-charts-Bj5N56Ou.js";import"./vendor-xlsx-BkI8taly.js";import"./vendor-echarts-DnurwZoN.js";import"./vendor-livekit-WT0eXGDi.js";const f=new Map,a=2*60*1e3;function h(o){const e=Date.now();if(f.size>200)for(const[i,t]of f)e-t>a&&f.delete(i);const r=f.get(o);return r&&e-r<a?!0:(f.set(o,e),!1)}async function b(o,e,r,i,t){try{const{data:{session:$}}=await y.auth.getSession();if(!$)return{ok:!1,error:"Not authenticated"};let u={ok:!0};try{const c=await v.functions.invoke("telegram-webhook",{body:{action:"dispatch_notification",company_id:o,event_type:e,html_message:r,...i?{target_warehouse_id:i}:{},...t?{role_messages:t}:{}}});c.error&&console.warn(`[TelegramNotify] ${e} response error (may be CORS):`,c.error),u=(c==null?void 0:c.data)||{ok:!0,sent:1}}catch(c){console.warn(`[TelegramNotify] ${e} fetch error (likely CORS, message may have been sent):`,c),u={ok:!0,sent:1,cors_fallback:!0}}return(u==null?void 0:u.sent)>0&&console.log(`[TelegramNotify] ${e}: sent=${u.sent}`),u}catch($){return console.warn("[TelegramNotify] Error:",$),{ok:!1,error:"Network error"}}}async function D(o,e){var r,i,t;try{const{data:{session:$}}=await y.auth.getSession();if(!$)return{ok:!1,error:"Not authenticated"};const u=((r=$.user.user_metadata)==null?void 0:r.full_name)||$.user.email||"User",c=new Date().toLocaleTimeString("en-US",{hour:"2-digit",minute:"2-digit"});if(o==="telegram"){const l=`🧪 <b>إشعار تجريبي — Test Notification</b>
━━━━━━━━━━━━━━━━━━━━
