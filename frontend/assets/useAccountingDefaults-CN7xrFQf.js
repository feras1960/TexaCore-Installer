import{m as o}from"./vendor-data-BWRv08bE.js";import{s as i}from"./index-uW0GslO4.js";function s(t){return o({queryKey:["accounting_defaults",t],queryFn:async()=>{if(!t)return null;const{data:e,error:a}=await i.from("company_accounting_settings").select(`
