...
`),u=e.shippingMethod?`
🚛 <b>طريقة الشحن:</b> ${w(e.shippingMethod)}`:"",t=e.shippingAddress?`
...
`),u=e.shippingMethod?`
🚛 طريقة النقل: ${w(e.shippingMethod)}`:"",t=e.driverName?`
...
${e.changedBy?`👤 بواسطة: ${e.changedBy}`:""}`;return b(n,"remittance_status_change",s.trim())}};export{S as default,L as sendTestNotification,S as telegramNotify};
