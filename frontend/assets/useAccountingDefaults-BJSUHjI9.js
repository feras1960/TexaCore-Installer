import{m as o}from"./vendor-data-BWRv08bE.js";import{s as i}from"./index-DfZRu9Cz.js";function s(t){return o({queryKey:["accounting_defaults",t],queryFn:async()=>{if(!t)return null;const{data:e,error:a}=await i.from("company_accounting_settings").select(`
