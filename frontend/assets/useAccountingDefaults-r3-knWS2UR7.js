import{m as o}from"./vendor-data-r3-D5N9kG8j.js";import{s as i}from"./index-r3-BFSsXH8x.js";function s(t){return o({queryKey:["accounting_defaults",t],queryFn:async()=>{if(!t)return null;const{data:e,error:a}=await i.from("company_accounting_settings").select(`
